...
<div id="popupForm" class="popup-form" style="display: none;">
    <div class="popup-content">
        <form action="student/calendar" method="post">
            ...
            <input readonly type="text" value="<?=$params['post']->Stagiaire_UserId?>" class="simple-input no-margin w-input" name="user_id" placeholder="ID de l'utilisateur" id="user-id" required/>
            <div class="spacer _16"></div>
