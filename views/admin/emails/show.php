...
<div class="dashboard-main-content">
    <div class="dashboard-page-header">
        <h2>Envoyée à</h2>
        <a href="/schl-hub/admin/emails" class="button page w-button">Retour à la messagerie</a>
    </div>
    <div class="_2-5-1-grid">
        <div class="module">
            <div class="module-main large">
                <h3 class="module-heading large"><?=$params['message'][0]['NomUrecepteur']?></h3>
                ...
                <div class="rich-text w-richtext">
                    ...
                    <p>___</p>
                    <p><?=$params['message'][0]['NomUrecepteur']?> Stagiaire</p>
                </div>
            </div>
        </div>
        <div class="action-group">
            <form hidden action="admin/emails/delete/<?=$params['message'][0]['idMessage']?>" style="display:inline" method="post">
