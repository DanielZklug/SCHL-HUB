            ...
            <div class="module-group">
                <div class="module">
                    <div class="module-header">
                        <h3 class="module-heading">Informations de la classe</h3>
                    </div>
...
<div id="popupForm" class="popup-form" style="display: none;">
    <div class="popup-content">
        ...
        <form action="/schl-hub/admin/classroom/<?=$params['class']['idClasse']?>" enctype="multipart/form-data" method="post">
