...
<div id="popupForm" class="popup-form" style="display: none;">
    <div class="popup-content">
        ...
        <form action="/schl-hub/admin/classroom" method="post">
            ...
            <input type="text" class="simple-input no-margin w-input" maxlength="10" name="nom_classe" data-name="Subscriber Email" value="<?=$params['posts']->Stagiaire_nom." ".$params['posts']->Stagiaire_prenom?>" disabled placeholder="Terminale A4" id="Subscriber-Email" required/>
