...
class ReceverController extends Controller{
    ...
    public function index(){
        ...
        $all = $posts->allMessageRecever($_SESSION['idStaUser']);

        return $this->viewStudent('student.emails.receved',compact('post', 'all'));
    }
    ...
    public function showReceved($id){
        ...
        return $this->viewStudent('student.emails.showreceved',compact('post', 'message'));
    }
